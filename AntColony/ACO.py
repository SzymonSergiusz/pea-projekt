...
# po pełnym przejściu
def CAS(feromony, Q, dlugosc_drogi):
    return feromony + (Q / dlugosc_drogi)
...
def ACO_CAS(graph, pokolenia, alfa, beta, ro, tau0, Q):
    ...
    for pokolenie in range(pokolenia):
        ...
        for ant in range(ants):
            ...
            # dodanie feromonów
            feromony = CAS(feromony, Q, distance)
...
if __name__ == '__main__':
    ...
    for f in file_dict:
        ...
        # print(est_cost)
        min_path, min_dist = ACO(graph, 50, alfa, beta, ro, tau0, est_cost, 'DAS')
        optimum = file_dict[f]
        print(
